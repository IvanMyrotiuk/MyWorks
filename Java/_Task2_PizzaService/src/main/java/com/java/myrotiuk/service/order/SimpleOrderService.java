...
public class SimpleOrderService implements OrderService {
	...
	public Order completeOrder(long orderId){
		...
		if(order.isPresent()){
			...
			double priceAfterDiscount = discountService.getPriceAfterDiscount(completedOrder);
			Optional<AccruedCard> optionalAccruedCard = completedOrder.getCustomer().getCard();
